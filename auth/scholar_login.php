...
//   $query = "SELECT * FROM users WHERE email=? AND role='scholar'";
...
//       header("Location: ../dashboard_pages/scholar_dashboard.php"); //dashboard_pages/admin_dashboard.php
//       exit();
//     } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($query) {
    ...
    // Verify the hashed password
    if (password_verify($password, $user['pword']) && $user['role'] === 'scholar') {
...
<head>
  ...
  <title>Scholar Login System</title>
...
<body>
  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
    ...
    <div class="scholarform">
      <form action="scholar_login.php" method="post">
        <input type="hidden" name="role" value="scholar">
        <!-- Include other login form fields (email, password) -->
